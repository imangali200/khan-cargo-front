...
<template>
    <div class="tw-py-6 animate-fadeIn">
        ...
        <!-- Header Card -->
        <div
            class="tw-bg-gradient-to-r tw-from-cyan-500 tw-to-cyan-600 tw-rounded-2xl tw-p-6 tw-mb-6 tw-shadow-lg tw-shadow-cyan-500/20">
        ...
        <div v-if="loading"
            ...
            <div
                class="tw-inline-flex tw-items-center tw-justify-center tw-w-16 tw-h-16 tw-bg-cyan-500/20 tw-rounded-full tw-mb-4">
                <div
                    class="tw-animate-spin tw-rounded-full tw-h-8 tw-w-8 tw-border-4 tw-border-cyan-500 tw-border-t-transparent">
                </div>
            </div>
                ...
                <form class="tw-space-y-6" @submit.prevent='createBranch'>
                    ...
                    <div class="tw-space-y-2">
                        <label class="tw-flex tw-items-center tw-gap-2 tw-text-sm tw-font-semibold tw-text-white/80"
                            for="nameBranch">
                            <svg class="tw-w-5 tw-h-5 tw-text-cyan-400" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
