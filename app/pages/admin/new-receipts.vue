  ...
  <div>
    ...
    <div class="tw-bg-white/[0.03] tw-backdrop-blur-xl tw-border tw-border-white/10 tw-rounded-2xl tw-p-5 tw-mb-4">
      <div class="tw-flex tw-items-center tw-justify-between tw-gap-4">
        <div class="tw-flex tw-items-center tw-gap-3 tw-flex-1">
          <div
            class="tw-w-12 tw-h-12 tw-rounded-xl tw-bg-gradient-to-br tw-from-emerald-500 tw-to-green-600 tw-flex tw-items-center tw-justify-center tw-text-white tw-flex-shrink-0">
            <svg class="tw-w-6 tw-h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z" />
            </svg>
          </div>
          <input ref="scannerInput" v-model="scannerCode" @keyup.enter="handleScannerInput" type="text"
    ...
    <div class="tw-bg-white/[0.03] tw-backdrop-blur-xl tw-border tw-border-white/10 tw-rounded-2xl tw-p-5 tw-mb-6">
      ...
      <div class="tw-flex tw-items-center tw-gap-3">
        <input v-model="manualCode" @keyup.enter="addManualCode" type="text" placeholder="Введите трек-код"
        ...
        <button @click="addManualCode" :disabled="!manualCode || loading"
    ...
    <div class="tw-bg-white/[0.03] tw-backdrop-blur-xl tw-border tw-border-white/10 tw-rounded-2xl tw-overflow-hidden">
      ...
      <!-- Table Header -->
      <div
        class="tw-hidden sm:tw-grid tw-grid-cols-2 tw-gap-4 tw-px-5 tw-py-3 tw-bg-white/[0.02] tw-border-b tw-border-white/10">
      ...
      <div class="tw-divide-y tw-divide-white/5">
        <div v-for="(item, index) in addedProducts" :key="index"
